...
import com.lzf.langchain4j.common.DeleteRequest;
...
import com.lzf.langchain4j.model.dto.app.*;
...
import com.lzf.langchain4j.service.ProjectDownloadService;
...
public class AppController {
    ...
    private Page<AppVO> pageAppVO(AppQueryRequest appQueryRequest) {
        long pageNum = appQueryRequest.getPageNum();
        long pageSize = appQueryRequest.getPageSize();
    ...
    private AppQueryRequest buildNameOnlyQueryRequest(AppQueryRequest appQueryRequest) {
        AppQueryRequest queryRequest = new AppQueryRequest();
        queryRequest.setAppName(appQueryRequest.getAppName());
        queryRequest.setPageNum(appQueryRequest.getPageNum());
        queryRequest.setPageSize(appQueryRequest.getPageSize());
        queryRequest.setSortField(appQueryRequest.getSortField());
        queryRequest.setSortOrder(appQueryRequest.getSortOrder());
        return queryRequest;
    }
}
